    ...
    <div className="text-black">
      <div className="flex flex-wrap gap-5 item-center justify-center">
        {membership.map((item, index) => {
          return (
            <div className="text-lg bg-slate-900 text-white border-2 pl-2 flex-col gap-3 justify-between pt-1 pb-1 rounded-xl font-semibold hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white">
      ...
      <div className="flex gap-10 mb-10">
        ...
        <div
          ...
          className="text-lg border-2 p-1 w-auto mt-0 rounded-xl hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white cursor-pointer hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white"
        >
          Add +
        </div>
      </div>
