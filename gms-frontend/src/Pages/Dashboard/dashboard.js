    ...
    <div className="w-3/4 text-black p-5 relative">
      <div className="w-full bg-slate-900 text-white rounded-lg flex p-3 justify-between item-center">
        ...
        <img
          ...
          src="https://i.pinimg.com/originals/64/2b/36/642b36429a803e41864b8906f6731cab.jpg"
          alt="gym"
        />
      </div>
      {accordianDashboard && (
        ...
        >
          ...
          <p>Feel Free To Ask Any Quaries</p>
        </div>
      )}
      ...
      <div className="mt-5 pt-3 bg-slate-100 bg-opacity-50 grid gap-5 grid-cols-3 w-full pb-5 overflow-x-auto h-[80%]">
        ...
        <Link
          ...
          onClick={() => handleOnClickMenu("inactiveMember")}
          className="w-full h-fit border-2 bg-white rounded-lg cursor-pointer"
        >
          <div className="h-3 rounded-t-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"></div>
      ...
      <div className="md:bottom-4 p-4 w-3/4 mb-4 md:mb-0 absolute hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white bg-black text-white mt-20 rounded-xl text-xl">
        Contact Developer for any Technical Error at +919889232881 (Ayush Singh)
      </div>
    </div>
  );
};
