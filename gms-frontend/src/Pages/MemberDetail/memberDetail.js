            ...
            {isDateInPast(data?.nextBillDate) && (
              <div
                ...
                className={`mt-1 rounded-lg p-3 border-2 border-slate-900 text-center ${
                  renew && status === "Active"
                    ? "bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white"
                    : null
                } w-full md:w-1/2 cursor-pointer hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white`}
              >
                Renew
              </div>
            )}
              ...
              <div className="rounded-lg p-3 mt-5  mb-5 h-fit bg-slate-50 md:w-[100%]">
                <div className="w-full">
                  <div className="my-5">
                    ...
                    <div
                      className={`mt-3 rounded-lg p-3 border-2 border-slate-900 text-center w-1/2 mx-auto cusor-pointer hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white`}
                      onClick={() => {
                        handleRenewSaveBtn();
                      }}
                    >
