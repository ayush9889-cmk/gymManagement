      ...
      <div className="mt-5 text-xl flex justify-between text-slate-900">
        ...
        {!isSearchModeOn ? (
          <div className="flex gap-5">
            ...
            <div
              className={`w-8 h-6 cursor-pointer border-2 flex item-center justify-center hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  hover:text-white  ${
